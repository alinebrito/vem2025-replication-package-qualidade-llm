const fs = require('fs');
const data = JSON.parse(fs.readFileSync('./data/dataUpdated.json'));
    ...
    for (const problem of problemsData) {
        try {
            ...
            updatedProblems.push({
                ...problem,
                classProblemData: graphqlData.data.questionDiscussionTopic
            });
...
async function main() {
    try {
        ...
        fs.writeFile("./data/dataUpdatedClasses.json", jsonContent, 'utf8', function (err) {
            if (err) {
